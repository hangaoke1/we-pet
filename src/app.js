...
class App extends Component {
  ...
  config = {
    pages: [ 'pages/search/index', 'pages/index/index', 'pages/pet/index', 'pages/petDetail/index', 'pages/petBreed/index', 'pages/confirmOrder/index', 'pages/cart/index', 'pages/product/index', 'pages/user/index', 'pages/addressUpdate/index', 'pages/addressAdd/index', 'pages/address/index', 'pages/shop/index', 'pages/login/index', 'pages/test/index', 'pages/webview/index', 'pages/remark/index' ],
    window: {
