...
class Cart extends Component {
  ...
  render() {
    ...
    const isSelectedAll = choosed.length === _.get(cart, 'items.length', 0) && choosed.length;
        ...
        {cart.items.length ? (
          ...
          <View className='u-empty'>
            ...
            <View className='text-center font-s-32'>
              <Text className='text-hui'>您的购物车是空的，</Text>
              <Text className='main-color' onClick={this.goShop}>
                去逛逛
              </Text>
            </View>
          </View>
