        ...
        <View className="u-form">
            ...
            <View className="u-form__value" onClick={this.showSex}>
              <View className="flex align-center">
                <View
                  ...
                  onClick={this.setSex.bind(this, 0)}
                >
                  {String(form.sex) === "0" ? (
                    <Iconfont
                      type="icongong-xuanzhong"
                      size="18"
                      color="#2F6BFE"
                    />
                  ) : (
                    <Iconfont
                      type="icongong-weixuanzhong"
                      size="18"
                      color="#ccc"
                    />
                  )}
                ...
                <View
                  ...
                  onClick={this.setSex.bind(this, 1)}
                >
                  {String(form.sex) === "1" ? (
                    <Iconfont type="iconmu-xuanzhong" size="18" color="pink" />
                  ) : (
                    <Iconfont
                      type="iconmu-weixuanzhong"
                      size="18"
                      color="#ccc"
                    />
                  )}
          ...
          <View className="u-form__item">
            ...
            <View className="u-form__value" onClick={this.goPetBreed}>
              {form.petBreed ? (
                <Text>{form.petBreed}</Text>
              ) : (
                <Text className="text-hui">请选择宠物品种</Text>
              )}
            </View>
          </View>
          <View className="u-form__item">
              ...
              >
                <View class="picker">
                  {form.birthday ? (
                    ...
                    <Text className="text-hui">请选择宝贝的生日</Text>
                  )}
                </View>
              </Picker>
            </View>
          ...
          <View className="u-form__item">
            ...
            <View className="u-form__value" onClick={this.showJueyu}>
              ...
              {String(form.bearFlag) === "" && (
                <Text className="text-hui">选填</Text>
              )}
            </View>
          </View>
        </View>
